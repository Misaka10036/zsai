...
import {
  ...
  initialTavilyValues,
  initialSeafileValues,
  initialProductionDataValues,
  initialDatasetWriteValues,
...
export const useInitializeOperatorParams = () => {
  ...
  const initialFormValuesMap = useMemo(() => {
    return {
      ...
      [Operator.Seafile]: initialSeafileValues,
      [Operator.ProductionData]: initialProductionDataValues,
      [Operator.DatasetWrite]: initialDatasetWriteValues,
